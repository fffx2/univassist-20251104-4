...
function generateSummaryReport() {
    ...
    const primaryColor = reportData.colors.primary['500'];
    const secondaryColor = reportData.colors.secondary['500'];
    ...
    // 명도 대비 계산
    const normalBgOptimal = appState.labColors.bgColor;
    const normalTextOptimal = appState.labColors.textColor;
    const normalRatio = calculateContrast(normalBgOptimal, normalTextOptimal);

    return `
        <div style="font-family: 'Pretendard', -apple-system, BlinkMacSystemFont, sans-serif; padding: 20px; background: white; color: #333;">
            <!-- 헤더 -->
            <div style="text-align: center; margin-bottom: 20px; padding-bottom: 15px; border-bottom: 3px solid ${primaryColor};">
                <h1 style="font-size: 28px; font-weight: 700; color: ${primaryColor}; margin: 0 0 8px 0;">TYPOUNIVERSE</h1>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                ...
                <div style="background: #f8f9fa; padding: 15px; border-radius: 8px;">
                    <h3 style="font-size: 14px; font-weight: 700; margin: 0 0 12px 0; color: #333;">주조/보조 컬러시스템</h3>
                    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 8px;">
                        <div style="text-align: center;">
                            <div style="width: 100%; height: 50px; background: ${primaryColor}; border-radius: 6px; margin-bottom: 5px;"></div>
                            <p style="font-size: 10px; margin: 0; color: #666;">Primary</p>
                            <p style="font-size: 9px; margin: 0; color: #999;">${primaryColor}</p>
                        </div>
                        <div style="text-align: center;">
                            <div style="width: 100%; height: 50px; background: ${secondaryColor}; border-radius: 6px; margin-bottom: 5px;"></div>
                            <p style="font-size: 10px; margin: 0; color: #666;">Secondary</p>
                            <p style="font-size: 9px; margin: 0; color: #999;">${secondaryColor}</p>
                        </div>
                        <div style="text-align: center;">
                            <div style="width: 100%; height: 35px; background: ${primaryLight}; border-radius: 6px; margin-bottom: 5px;"></div>
                            <p style="font-size: 9px; margin: 0; color: #999;">Light ${primaryLight}</p>
                        </div>
                        <div style="text-align: center;">
                            <div style="width: 100%; height: 35px; background: ${secondaryLight}; border-radius: 6px; margin-bottom: 5px;"></div>
                            <p style="font-size: 9px; margin: 0; color: #999;">Light ${secondaryLight}</p>
                        </div>
                        <div style="text-align: center;">
                            <div style="width: 100%; height: 35px; background: ${primaryDark}; border-radius: 6px; margin-bottom: 5px;"></div>
                            <p style="font-size: 9px; margin: 0; color: #999;">Dark ${primaryDark}</p>
                        </div>
                        <div style="text-align: center;">
                            <div style="width: 100%; height: 35px; background: ${secondaryDark}; border-radius: 6px; margin-bottom: 5px;"></div>
                            <p style="font-size: 9px; margin: 0; color: #999;">Dark ${secondaryDark}</p>
                        </div>
                    </div>
                </div>
                ...
                <!-- 타이포그래피 -->
                <div style="background: #f8f9fa; padding: 15px; border-radius: 8px;">
                    <h3 style="font-size: 14px; font-weight: 700; margin: 0 0 12px 0; color: #333;">웹폰트 페어링</h3>
                    <div style="margin-bottom: 10px;">
                        <p style="font-size: 11px; color: #666; margin: 0 0 3px 0; font-weight: 600;">Heading Font</p>
                        <p style="font-size: 16px; font-weight: 700; margin: 0; font-family: '${reportData.fonts.heading}', serif;">${reportData.fonts.heading}</p>
                    </div>
                    <div style="margin-bottom: 10px;">
                        <p style="font-size: 11px; color: #666; margin: 0 0 3px 0; font-weight: 600;">Body Font</p>
                        <p style="font-size: 13px; margin: 0; font-family: '${reportData.fonts.body}', sans-serif;">${reportData.fonts.body}</p>
                    </div>
                    <div>
                        <p style="font-size: 11px; color: #666; margin: 0 0 3px 0; font-weight: 600;">한글 폰트</p>
                        <p style="font-size: 13px; margin: 0; font-family: '${reportData.fonts.korean}', sans-serif;">${reportData.fonts.korean}</p>
                    </div>
                    <div style="margin-top: 12px; padding: 8px; background: white; border-radius: 6px; border-left: 3px solid ${primaryColor};">
                        <p style="font-size: 9px; color: #666; margin: 0; line-height: 1.5;">${document.getElementById('font-reasoning')?.textContent || '폰트 조합이 서비스 성격에 최적화되어 있습니다.'}</p>
                    </div>
                </div>
            </div>
            ...
            <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; margin-top: 15px;">
                <h3 style="font-size: 14px; font-weight: 700; margin: 0 0 10px 0; color: #333;">플랫폼별 타이포그래피 가이드 (${appState.platform})</h3>
                <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 12px;">
                    <div>
                        <p style="font-size: 10px; font-weight: 600; margin: 0 0 5px 0; color: #666;">명도대비</p>
                        <p style="font-size: 9px; line-height: 1.5; margin: 0; color: #777;">${document.getElementById('contrast-description-report')?.textContent || 'WCAG 2.1 AA 기준 준수'}</p>
                    </div>
                    <div>
                        <p style="font-size: 10px; font-weight: 600; margin: 0 0 5px 0; color: #666;">권장 사이즈</p>
                        <div style="font-size: 9px; line-height: 1.5; color: #777;">${document.getElementById('font-size-description-report')?.innerHTML || ''}</div>
                    </div>
                </div>
            </div>
            ...
            <!-- 유니버설 컬러시스템 -->
            <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; margin-top: 15px;">
                <h3 style="font-size: 14px; font-weight: 700; margin: 0 0 10px 0; color: #333;">유니버설 컬러시스템 최적화</h3>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                    <div style="background: white; padding: 10px; border-radius: 6px; border: 1px solid #e0e0e0;">
                        <p style="font-size: 10px; font-weight: 600; margin: 0 0 8px 0; color: #666;">일반 시각 최적 조합</p>
                        <div style="display: flex; gap: 8px; margin-bottom: 8px;">
                            <div style="flex: 1; text-align: center;">
                                <div style="width: 100%; height: 35px; background: ${normalBgOptimal}; border-radius: 4px; margin-bottom: 3px; border: 1px solid #ddd;"></div>
                                <p style="font-size: 8px; margin: 0; color: #999;">BG ${normalBgOptimal}</p>
                            </div>
                            <div style="flex: 1; text-align: center;">
                                <div style="width: 100%; height: 35px; background: ${normalTextOptimal}; border-radius: 4px; margin-bottom: 3px; border: 1px solid #ddd;"></div>
                                <p style="font-size: 8px; margin: 0; color: #999;">TEXT ${normalTextOptimal}</p>
                            </div>
                        </div>
                        <div style="background: ${normalBgOptimal}; color: ${normalTextOptimal}; padding: 8px; border-radius: 4px; text-align: center;">
                            <p style="font-size: 9px; margin: 0; font-weight: 600;">명도 대비: ${normalRatio.toFixed(2)}:1</p>
                        </div>
                    </div>
                    <div style="background: white; padding: 10px; border-radius: 6px; border: 1px solid #e0e0e0;">
                        <p style="font-size: 10px; font-weight: 600; margin: 0 0 8px 0; color: #666;">색각 이상자 시각 최적 조합</p>
                        <div style="display: flex; gap: 8px; margin-bottom: 8px;">
                            <div style="flex: 1; text-align: center;">
                                <div style="width: 100%; height: 35px; background: ${optimizeForColorblind(normalBgOptimal)}; border-radius: 4px; margin-bottom: 3px; border: 1px solid #ddd;"></div>
                                <p style="font-size: 8px; margin: 0; color: #999;">BG ${optimizeForColorblind(normalBgOptimal)}</p>
                            </div>
                            <div style="flex: 1; text-align: center;">
                                <div style="width: 100%; height: 35px; background: ${optimizeForColorblind(normalTextOptimal)}; border-radius: 4px; margin-bottom: 3px; border: 1px solid #ddd;"></div>
                                <p style="font-size: 8px; margin: 0; color: #999;">TEXT ${optimizeForColorblind(normalTextOptimal)}</p>
                            </div>
                        </div>
                        <div style="background: ${optimizeForColorblind(normalBgOptimal)}; color: ${optimizeForColorblind(normalTextOptimal)}; padding: 8px; border-radius: 4px; text-align: center;">
                            <p style="font-size: 9px; margin: 0; font-weight: 600;">명도 대비: ${calculateContrast(optimizeForColorblind(normalBgOptimal), optimizeForColorblind(normalTextOptimal)).toFixed(2)}:1</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- 컴포넌트 미리보기 -->
            <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; margin-top: 15px;">
                <h3 style="font-size: 14px; font-weight: 700; margin: 0 0 10px 0; color: #333;">컴포넌트 미리보기</h3>
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px;">
                    <!-- 버튼 -->
                    <div style="text-align: center;">
                        <div style="background: ${primaryColor}; color: ${getContrastingTextColor(primaryColor)}; padding: 10px; border-radius: 6px; font-size: 11px; font-weight: 600; margin-bottom: 5px;">Primary Button</div>
                        <p style="font-size: 9px; margin: 0; color: #666;">Primary Button</p>
                    </div>
                    <div style="text-align: center;">
                        <div style="background: ${secondaryColor}; color: ${getContrastingTextColor(secondaryColor)}; padding: 10px; border-radius: 6px; font-size: 11px; font-weight: 600; margin-bottom: 5px;">Secondary Button</div>
                        <p style="font-size: 9px; margin: 0; color: #666;">Secondary Button</p>
                    </div>
                    <div style="text-align: center;">
                        <div style="background: transparent; color: ${primaryColor}; padding: 9px; border-radius: 6px; font-size: 11px; font-weight: 600; margin-bottom: 5px; border: 2px solid ${primaryColor};">Outline Button</div>
                        <p style="font-size: 9px; margin: 0; color: #666;">Outline Button</p>
                    </div>
                </div>
                
                <!-- 카드 -->
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-top: 10px;">
                    <div style="background: white; padding: 12px; border-radius: 6px; border-left: 3px solid ${primaryColor};">
                        <h4 style="font-size: 12px; font-weight: 700; color: ${primaryColor}; margin: 0 0 5px 0; font-family: '${reportData.fonts.heading}', serif;">Premium Card</h4>
                        <p style="font-size: 9px; line-height: 1.5; margin: 0; color: #666;">프리미엄 디자인 시스템을 적용한 카드 컴포넌트입니다.</p>
                    </div>
                    <div style="background: white; padding: 12px; border-radius: 6px; border-left: 3px solid ${secondaryColor};">
                        <h4 style="font-size: 12px; font-weight: 700; color: ${secondaryColor}; margin: 0 0 5px 0; font-family: '${reportData.fonts.heading}', serif;">Secondary Card</h4>
                        <p style="font-size: 9px; line-height: 1.5; margin: 0; color: #666;">보조 색상을 활용한 카드 디자인입니다.</p>
                    </div>
                </div>
            </div>
            ...
            <!-- 색상 사용 가이드 -->
            <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; margin-top: 15px;">
                <h3 style="font-size: 14px; font-weight: 700; margin: 0 0 10px 0; color: #333;">색상 사용 가이드</h3>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                    <div>
                        <p style="font-size: 10px; font-weight: 600; margin: 0 0 5px 0; color: ${primaryColor};">• Primary 색상</p>
                        <p style="font-size: 9px; line-height: 1.5; margin: 0 0 8px 0; color: #666;">주요 액션 버튼, 링크, 브랜드 강조 요소에 사용</p>
                        <p style="font-size: 10px; font-weight: 600; margin: 0 0 5px 0; color: ${primaryLight};">• Primary Light</p>
                        <p style="font-size: 9px; line-height: 1.5; margin: 0; color: #666;">배경, 호버 상태, 부드러운 강조에 사용</p>
                    </div>
                    <div>
                        <p style="font-size: 10px; font-weight: 600; margin: 0 0 5px 0; color: ${secondaryColor};">• Secondary 색상</p>
                        <p style="font-size: 9px; line-height: 1.5; margin: 0 0 8px 0; color: #666;">보조 액션, 구분 요소, 다양성 표현에 사용</p>
                        <p style="font-size: 10px; font-weight: 600; margin: 0 0 5px 0; color: ${primaryDark};">• Primary Dark</p>
                        <p style="font-size: 9px; line-height: 1.5; margin: 0; color: #666;">텍스트, 아이콘, 강한 대비가 필요한 요소에 사용</p>
                    </div>
                </div>
            </div>

            <!-- 푸터 -->
            <div style="text-align: center; margin-top: 20px; padding-top: 15px; border-top: 2px solid #e0e0e0;">
                <p style="font-size: 10px; color: #999; margin: 0;">Generated by TYPOUNIVERSE AI Design Assistant</p>
                <p style="font-size: 9px; color: #bbb; margin: 3px 0 0 0;">www.typouniverse.com</p>
            </div>
        </div>
    `;
}// ============================================
